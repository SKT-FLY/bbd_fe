...
class _AdotScreenState extends State<AdotScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return CupertinoPageScaffold(
      ...
      child: Padding(
        padding: EdgeInsets.all(screenWidth * 0.05), // 화면 크기의 4%를 패딩으로 설정
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            SizedBox(height: screenHeight * 0.1), // 화면 높이의 10%를 상단 여백으로 설정
            Text(
              '깊은 밤이에요. 오늘 하루를 마무리하는\n편안한 시간 보내세요.',
              style: TextStyle(
                fontSize: screenWidth * 0.06, // 화면 너비의 6%를 글자 크기로 설정
                fontWeight: FontWeight.bold,
              ),
            ),
            SizedBox(height: screenHeight * 0.02), // 화면 높이의 2%를 간격으로 설정
            Column(
              children: [
                CupertinoButton(
                  onPressed: () {},
                  ...
                  padding: EdgeInsets.symmetric(
                    vertical: screenHeight * 0.02, // 화면 높이의 2%를 패딩으로 설정
                  ),
                  child: Align(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        fontSize: screenWidth * 0.045, // 화면 너비의 4.5%를 글자 크기로 설정
                      ),
                    ),
                  ),
                ),
                SizedBox(height: screenHeight * 0.01), // 화면 높이의 1%를 간격으로 설정
                CupertinoButton(
                  onPressed: () {},
                  color: CupertinoColors.systemGrey6,
                  padding: EdgeInsets.symmetric(
