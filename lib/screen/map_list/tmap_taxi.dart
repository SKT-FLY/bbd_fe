...
class _TaxiSearchPageState extends State<TaxiSearchPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoPageScaffold(
      ...
      child: SafeArea(
        child: Stack( // Stack 위젯으로 변경하여 홈 버튼의 위치를 조정
          children: [
            Column(
              children: [
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: TaxiSearchPage.customOrange, // 노란 배경색
                    ...
                    child: const Icon(
                      CupertinoIcons.home,
                      color: CupertinoColors.black, // 홈 아이콘을 검정색으로 설정
                      size: 50,
                    ),
                  ),
                ),
